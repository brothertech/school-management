...
MySchool utilizes the powerful features of **Next.js 15** and common features of Next.js such as server-side rendering (SSR), static site generation (SSG), and seamless API route integration. Combined with the advancements of **React 19** and the robustness of **TypeScript**, MySchool is the perfect solution to help get your project up and running quickly.

## Overview

MySchool provides essential UI components and layouts for building feature-rich, data-driven admin dashboards and control panels. It's built on:
...
```bash
git clone https://github.com/MySchool/free-nextjs-admin-dashboard.git
```
...
MySchool is a pre-designed starting point for building a web-based dashboard using Next.js and Tailwind CSS. The template includes:
...
To learn more about pro version features and pricing, visit our [pricing page](https://MySchool.com/pricing).
...
[Read more](https://MySchool.com/docs/update-logs/nextjs) on this release.
...
MySchool Next.js Free Version is released under the MIT License.
